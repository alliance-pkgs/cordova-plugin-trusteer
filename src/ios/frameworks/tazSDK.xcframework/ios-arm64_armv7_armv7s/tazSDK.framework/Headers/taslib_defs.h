...
#define TAS_RESULT_DEVICE_IS_COMPROMISED            -20 /**< \brief The device is compromised*/
#define TAS_RESULT_WRONG_DEVICE_KEY_METHOD          -21 /**< \brief The wrong method for getting the device key was used */
...
#define TAS_DRA_ITEM_INFO_ERROR_NONE                  0 /**< \brief   No error */
#define TAS_DRA_ITEM_INFO_ERROR_NO_PERMISSION         2 //**< \brief Indication for missing permissions to take/calculate data*/
...
#endif /* __taslib_defs_h_included__ */
