...
#define TAS_RESULT_CONNECTION_INTERNAL_TIMEOUT      -17 /**< \brief Connection started but closed because of connection read/write timeout*/
#define TAS_RESULT_PINPOINT_CERTIFICATE_PROBLEM     -18 /**< \brief Connection started but closed because of connection read/write timeout*/
