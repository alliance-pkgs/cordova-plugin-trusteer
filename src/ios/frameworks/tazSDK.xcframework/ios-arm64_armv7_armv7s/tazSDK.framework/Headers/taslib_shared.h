 ...
 */
TAS_RESULT TAS_API qzdkollqfnbw(
 ...
 */
TAS_RESULT TAS_API qmvzsrdjbseh(
 ...
 */
TAS_RESULT TAS_API gmuvifrmxjmh(
...
#define TasSetUserId(userId) qzdkollqfnbw(userId)
#define TasRaGetStatus(tasStatusInfo) qmvzsrdjbseh(tasStatusInfo)
#define TasSetPUID(puid) gmuvifrmxjmh(puid)

#endif /* __taslib_shared_h_included__ */
